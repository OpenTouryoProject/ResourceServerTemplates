...
xcopy /E /Y /I "OpenTouryo\root\programs\CS\Frameworks\Infrastructure\Build_netcore30" "ResourceServerTemplates\root\programs\OpenTouryoAssemblies\Build_netcore30\"